                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="section-title mb-40">
                                <h2 className="title">Live Auctions <picture><img src={process.env.NEXT_PUBLIC_APP_URL+"/assets/img/icons/title_icon01.png"} alt="" /></picture></h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="top-collection-item">
                                <div className="collection-item-thumb">
                                    <div className="shield-icon"><picture>
                                        <img alt="" src={process.env.NEXT_PUBLIC_APP_URL+"/assets/img/others/shield.png"} /></picture>
                                    </div>
