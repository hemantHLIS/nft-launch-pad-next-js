                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div className="top-collection-item">
                        ...
                        <div className="collection-item-bottom">
                            <ul>
                                <li className="avatar"><a href="nftdetails.php" className="thumb"><picture><img src="assets/img/others/top_col_avatar.png" alt="" /></picture></a>By <a href="#" className="name">Jonson</a></li>
